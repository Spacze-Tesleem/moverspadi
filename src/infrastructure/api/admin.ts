...
import type { UserStatus, VerificationStatus } from "@/src/domain/auth/types";
import type { BookingStatus, PaymentStatus, PayoutStatus, VehicleType, ServiceType } from "@/src/domain/booking/types";
